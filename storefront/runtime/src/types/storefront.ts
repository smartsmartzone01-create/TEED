...
export type StorefrontCategory = { id: string; source: "catalog" | "standalone" | "family"; listingIds?: string[]; familyIds?: string[]; title: LocalizedText; description: LocalizedText; href: string; imageUrl?: string };
