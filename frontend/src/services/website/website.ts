...
function updateWebsiteSite(businessId: string, siteId: string, values: { featured_products?: unknown; header?: unknown; hero?: unknown; navigation?: unknown }, accessToken: string) {
