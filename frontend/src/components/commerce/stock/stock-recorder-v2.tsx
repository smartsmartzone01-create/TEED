...
import { StockRecordingWorkspaceV2 } from "@/components/commerce/stock/stock-recording-workspace-v2";
...
function StockRecorderV2({ businessId }: { businessId: string }) {
  ...
  return (
    <div className="stock-recorder-v2-shell grid min-w-0 gap-4">
      ...
      <StockRecordingWorkspaceV2
        businessId={businessId}
        recordingOpen={recordingOpen}
        onRecordingRequested={() => setRecordingOpen(true)}
