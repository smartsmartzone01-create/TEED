# Generated by Django 5.2.16 on 2026-07-25 17:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'constraints': [models.UniqueConstraint(django.db.models.functions.text.Lower('email'), condition=models.Q(('email__isnull', False)), name='identity_user_email_ci_unique'), models.UniqueConstraint(django.db.models.functions.text.Lower('username'), condition=models.Q(('username__isnull', False)), name='identity_user_username_ci_unique')],
            },
            managers=[
